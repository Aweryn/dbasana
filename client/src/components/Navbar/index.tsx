    ...
    <div className="flex items-center justify-between bg-white px-4 py-3 dark:bg-black dark:px-4 dark:py-3">
      ...
      <div className="flex items-center gap-8">
        ...
        <div className="relative flex h-min w-[200px]">
          <Search className="absolute left-[4px] top-1/2 h-5 w-5 mr-2 -translate-y-1/2 transform cursor-pointer dark:text-white" />
          <input type="text" placeholder="Search..." className="w-full rounded border-none bg-gray-100 p-2 pl-8 placeholder-gray-500 focus:border-transparent focus:outline-none dark:bg-gray-700 dark:text-white dark:placehodler-white" />
        </div>
      </div>
      ...
      <div className="flex items-center">
        ...
        className={
          ...
          : `rounded h-min w-min p-2 hover:bg-gray-700`
          }
          >
