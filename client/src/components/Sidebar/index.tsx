...
import { Home, Briefcase, LockIcon, Search, Settings, X, User, Users, LucideIcon, ChevronUp, ChevronDown, AlertCircle, ShieldAlert, AlertTriangle, AlertOctagon, Layers3 } from 'lucide-react';
...
const Sidebar = () => {
    ...
    shadow-xl transition-all duration-300 z-40 dark:bg-black overflow-y-auto bg-white
        ...
        return <div className={sidebarClassNames}>
            <div className="flex flex-col h-full w-full justify-start">
                ...
                <div className="flex items-center gap-5 border-y-[1.5px] border-gray-200 px-8 py-4 dark:border-gray-700">
                    <Image src={`${process.env.NEXT_PUBLIC_S3_BUCKET_URL}/logo.png`} alt="Logo" width={40} height={40} />
                        <div>
                            <h3 className="text-md font-bold tracking-wide dark:text-gray-200">Team</h3>
                ...
                <nav className="z-10 w-full">
                    ...
                    <SidebarLink href="/timeline" icon={Briefcase} label="Projects" />
