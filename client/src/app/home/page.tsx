...
import { useGetTasksQuery, useGetProjectsQuery, Task, Priority, Project } from '@/state/api';
import React from 'react'
import { useAppSelector } from '../redux';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { ResponsiveContainer, BarChart, Bar, PieChart, Pie, Cell, CartesianGrid, YAxis, XAxis, Tooltip, Legend } from 'recharts';
...
const HomePage = () => {
    ...
    if (tasksError || projectsError) return <div>Error fetching tasks or projects</div>;
    ...
    const taskColumns: GridColDef[] = [
        ...
        { field: "priority", headerName: "Priority", flex: 200 },
        { field: "dueDate", headerName: "Due Date", flex: 200 },
    ];
