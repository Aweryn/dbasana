...
import { EllipsisVertical, MessageSquareIcon, MessageSquareMore, Plus } from 'lucide-react';
...
const TaskColumn = ({
    ...
    return (
        ...
        className={`sl:py-4 rounded-lg py-2 xl:px-2 ${isOver ? "bg-blue-100 dark:bg-neutral-950" : "bg-neutral-100 dark:bg-neutral-900"}`}
        >
            <div className="mb-3 flex w-full">
                ...
                <div className="flex w-full items-center justify-between rounded-e-lg bg-white px-5 py-4 dark:bg-dark-secondary">
                    ...
                    <div className="flex items-center gap-1">
                        ...
                        <button className="flex h-6 w-6 items-center justify-center rounded bg-gray-200 dark:bg-dark-tertiary dark:text-neutral-500"
...
const TaskCard = ({ task }: TaskProps) => {
    ...
    const numberOfComments = task.comments && task.comments.length > 0 ? task.comments.length : 0;
                    ...
                    <div className="flex flex-1 flex-wrap items-center gap-2">
                        ...
                        <div className="flex gap-2">
                            {taskTagsSplit.map((tag) => (
                                <div className="rounded-full bg-blue-100 px-2 py-1 text-xs" key={tag}>
                                    {tag}
                                </div>
                            ))}
                        </div>
